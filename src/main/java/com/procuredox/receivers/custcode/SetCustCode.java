...
public class SetCustCode {
    private static final Logger log = LoggerFactory.getLogger(SetCustCode.class);
    ...
    public Response setCustCode(SetCustCodeRequest custcode){
        try{
            ...
            if(custcode.getCustCodeId() == null){
                ...
                sqlStmt.setString(1, custcode.getSecKey());
